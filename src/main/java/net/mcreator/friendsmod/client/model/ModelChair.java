...
public class ModelChair<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("friends_mod", "model_chair"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(24, 27).addBox(-2.0F, -15.0F, 0.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 27)
