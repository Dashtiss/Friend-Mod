...
public class MinigunItem extends Item {
	public MinigunItem() {
		super(new Item.Properties().tab(FriendsModModTabs.TAB_FURNITURE).durability(100));
	}
	...
	public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MinigunEntity entityarrow = MinigunEntity.shoot(world, entity, world.getRandom(), 2.3f, 4, 0);
