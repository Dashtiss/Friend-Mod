...
package net.mcreator.friendsmod.world.features;
...
public class Noobhut3Feature extends Feature<NoneFeatureConfiguration> {
	public static Noobhut3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Noobhut3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("friends_mod:noobhut_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("friends_mod:noobhut_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("friends_mod", "noob_hut"));
		if (template == null)
			return false;
